"""
Network from Alex Kell's and Dan Yamins' 2018 Neuron Paper "A task-optimized neural network replicates 
human auditory behavior, predicts brain responses, and reveals a cortical processing hierarchy." This 
network can also be found in the repo https://github.com/mcdermottLab/kelletal2018. 
"""
import h5py 
import numpy as np
...
class branched_network(object):
    ...
    def get_graph(self):
        ...
        #Make tf session
        self.conv_layers=[h_conv1,h_conv2,h_conv3,h_conv4_W,h_conv5_W,h_conv4_G,h_conv5_G]
